...
- 搜索、筛选、排序、收藏、置顶、备注、删除、清空历史，单条删除和清空操作带确认，清空未置顶和清空全部都会按完整历史准确统计，核心检查覆盖 5,000 条历史搜索。
...
- 设置页提供运行状态总览，可查看记录状态、自动粘贴权限、最近应用、历史数量、数据占用，并可直接在 Finder 中打开数据目录。
