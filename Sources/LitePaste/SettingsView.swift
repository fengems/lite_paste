...
struct SettingsView: View {
  ...
  private var clipboardSettingsPage: some View {
    ClipboardSettingsPage(
      ...
      formatsTablePlainText: settingsBindings.formatsTablePlainText,
      tablePlainTextSeparator: settingsBindings.tablePlainTextSeparator,
      tablePlainTextWrapper: settingsBindings.tablePlainTextWrapper,
